...
export default class List extends React.Component{
	...
	sort(){
		...
		var url = 'http://w.lefeng.com/api/neptune/search/search_by_keyword/v1?keyword='+kd+'&sort=%7B%22vipshopPrice%22%3A%22asc%22%7D'
	...
	pos(){
		...
		var kd = this.props.location.query.val
		var wo = this.props.location.query.wod
		var url = 'http://w.lefeng.com/api/neptune/search/search_by_keyword/v1?keyword='+kd+'&sort=%7B%22sale%22%3A%22desc%22%7D'
		MyAjax.fetchJsonp(url,function(data){
			var res = data.data
			that.setState({
				proList:res
	...
	componentWillMount(){
		...
		var kd = this.props.location.query.val
		var wo = this.props.location.query.wod
		var url = 'http://w.lefeng.com/api/neptune/search/search_by_keyword/v1?keyword='+kd
		MyAjax.fetchJsonp(url,function(data){
			var res = data.data
			that.setState({
				proList:res
		...
		var url = 'http://w.lefeng.com/api/neptune/search/search_by_keyword/v1?keyword='+wo
		MyAjax.fetchJsonp(url,function(data){
			var res = data.data
			that.setState({
				proList:res
